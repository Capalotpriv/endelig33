      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            <h3 className="text-xl font-serif font-medium">Vusto</h3>
          ...
          <div className="space-y-4">
            ...
            <address className="not-italic text-muted-foreground">
              ...
              <p className="mt-2">contact@Vustorestaurant.com</p>
              <p>(555) 123-4567</p>
            </address>
          </div>
        ...
        <div className="border-t border-border mt-12 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
          <p>&copy; {currentYear} Vusto Restaurant. All rights reserved.</p>
